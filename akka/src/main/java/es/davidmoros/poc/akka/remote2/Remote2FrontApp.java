...
public final class Remote2FrontApp {
	private static final String AKKA_CONFIG_FILENAME = "remote2/akka-remote2-front.conf";
	public static void main(String[] args) throws InterruptedException {
		startup ("5000", new String[] {"2551", "2552"}, 10);
	}
